...
export const SCRIPT_TEMPLATES: ScriptSuggestion[] = [
  {
    ...
    title: 'דו-שיח',
    podcastName: 'מדברים הערכה',
    participants: 'נועם ומיכל',
    content: `נועם: "שלום לכולם, אני נועם ואיתי נמצאת מיכל. אנחנו מקליטים ישירות מהמכללה לחינוך במסגרת קורס הערכת הישגים ב-MTEACH. היום אנחנו רוצים לשאול את עצמנו: למה כל כך קשה לנו, כמורים לעתיד, ליישם הערכה חלופית בכיתות הטרוגניות בישראל?"

נועם: "כשנכנסתי השבוע להתנסות המעשית בבית הספר, ראיתי שהמורים מוצפים בעומס מטורף. בסוף הם פשוט חוזרים למבחנים הרגילים של פעם שמבוססים על שינון. קשה להם מאוד לנהל תהליך אמיתי של הערכה לשם למידה (AfL), כשיש להם שלושים תלמידים בכיתה עם פערים עצומים. מיכל, את חושבת שזה רק עניין של חוסר זמן, או שיש כאן בעיה עמוקה יותר במערכת?"

מיכל: "אני לגמרי מבינה את מה שראית בכיתה, נועם, וזה באמת אתגר קשוח. אבל אני מאמינה שהמפתח נמצא במה שסיכמנו בשיעור האחרון – המעבר לציון מספרי יבש הוא מה שמקבע את הפערים. אם נתחיל להשתמש במשוב איכותני מקדם למידה, נוכל לתת לכל תלמיד בכיתה ההטרוגנית הזו יעד שמותאם אישית אליו. זה משנה לחלוטית את חוויית המסוגלות והמוטיבציה שלו."

מיכל: "בשורה התחתונה, כל עוד משרד החינוך ימשיך למדוד אותנו רק בשורות תחתונות של ציונים, יהיה לנו קשה לשנות את התרבות הזו בשטח. תודה שהקשבתם לנו, אנחנו היינו נועם ומיכל ב'מדברים הערכה', נתראה בפרק הבא!"`,
    cards: [
  ...
  },
  {
    id: 'panel_sociology',
    title: 'פאנל עמיתים',
    podcastName: 'סוציולוגיה מהשטח',
    participants: 'מנחה, עמית ושירה',
    content: `מנחה: "שלום לכולם, אתם בפאנל המהיר של 'סוציולוגיה מהשטח'. אני כאן עם עמית ושירה, והיום בדקה אחת אנחנו שואלים את עצמנו: האם המקיפים בפריפריה בישראל באמת פותחים דלתות, או שהם עדיין מייצרים הסללה סמויה? עמית, מה אתה רואה בשטח?"

עמית: "תשמעו, כשאני מסתכל על מה שקורה בהתנסות המעשית שלי השנה בבית הספר בדרום, אי אפשר שלא לראות את בורדייה קם לתחייה. לתלמידים שמגיעים מרקע מוחלש יש פחות מה שהאקדמיה מגדירה הון תרבותי, ובמקום שהמערכת תצמצם את הפער, היא מנתבת אותם מראש למגמות מקצועיות פחות נחשבות. זו פשוט הסללה מודרנית, רק בשמות מכובסים."

שירה: "אני מבינה לגמרי את האכזבה שלך ממה שראית, עמית, אבל אני רוצה לאתגר את הגישה הפסימיסטית הזו. בתיכון הטכנולוגי שאני מתנסה בו במרכז, המגמות האלו הן ה-מנוף למוביליות חברתית. התלמידים שלי מקבלים הסמכות טכנולוגיות שנותנות להם כרטיס כניסה ישיר לתפקידים יוקרתיים בצבא ומשם להייטק. זה משנה את מסלול החיים שלהם, בלי קשר לנקונדת הזינוק."

מנחה: "אז המתח בין שעתוק פערים להזדמנות אמיתית נשאר הדילמה הכי גדולה שלנו כמורים לעתיד. תודה לעמית ושירה על הדיון המרתק, נתראה בפרק הבא של 'סוציולוגיה מהשטח'!"`,
    cards: [
  ...
  },
  {
    ...
    title: 'ראיון',
    podcastName: 'חינוך בגובה העיניים',
    participants: 'נועם ומיכל',
    content: `מראיין: "ברוכים הבאים ל'חינוך בגובה העיניים'. אני נועם, והיום אני מארח את מיכל כדי להבין איך אפשר להחיות את מרטין בובר בכיתות הנוער של היום. מיכל, שלום לך."

מראיין: "השבוע הגעתי להתנסות המעשית בתיכון, וזה היה מייאש. חצי כיתה הייתה בתוך הטלפונים, והרגשתי שהתקשורת בינינו היא לגמרי מה שבובר מכנה יחסי אני-לז – הם ראו בי רק פונקציה שמפריעה להם, ואני ראיתי בהם הפרעה. איך מפרקים את הניכור הזה בדור המסכים?"

מיכל: "נועם, מה שחווית זו בדיוק הבעיה של מערכת החינוך המודרנית שמקדשת רק הספק וציונים. בובר לא אמר שזה קל, אבל הוא טען שכדי לייצר זיקה דיאלוגית של אני-אתה, אתה לא צריך מערך שיעור מושלם. אתה צריך פשוט להוריד את המגננות, להסתכל לתלמיד בעיניים, ולהקשיב לו באמת אפילו לדקה אחת. ברגע שתלמיד מרגיש שפגשת אותו כאדם, המסך פשוט יורד לבד."

מראיין: "אז אולי במקום להחרים טלפונים, פשוט נתחיל לדבר איתם בגובה העיניים. תודה רבה מיכל, ותודה לכם המאזינים. נתראה בפרק הבא!"`,
    cards: [
  ...
  },
  {
    id: 'host_expert_sel',
    title: 'מנחה ומומחה',
    podcastName: 'מחשבים מסלול פדגוגי',
    participants: 'נועם ומיכל',
    content: `אני (מנחה): "שלום לכולם, אני נועם ואתם ב'מחשבים מסלול פדגוגי' מהמכללה לחינוך. היום נבין איך מנהלים כיתה סוערת בלי להרים את הקול, ואיתי באולפן נמצאת מיכל, הסטודנטית המומחית שלנו לקשר שבין רגש ללמידה. שלום מיכל."

אני (מנחה): "מיכל, השבוע בהתנסות המעשית שלי בחטיבת הביניים הרגשתי שאני שוטר ולא מורה. התלמידים היו חסרי שקט, הניידים צפצפו, והרגשתי שאין לי שום כלי לייצר אקלים כיתה מיטבי כשכולם בתוך סערה. איך התיאוריה שלמדנו יכולה בכלל לפגוש בלגן כזה בזמן אמת?"

מיכל (מומחית): "נועם, הקושי שחווית הוא בדיוק המקום שבו אנחנו חייבים לשנות דיסקט בשטח. הספרות המחקרית מראה שאי אפשר להשתיק כיתה בכוח, אלא חייבים להכניס למידה רגשית-חברתית (SEL) כחלק בלתי נפרד מהשיעור. כשאתה עוצר לשלוש דקות של תרגול ויסות רגשי או שיתוף קצר בפתיחת השיעור, התלמידים נרגעים, מרגישים שרואים אותם, והפניות שלהם להקשיב לחומר העיוני מזנקת."

אני (מנחה): "אז בשורה התחתונה – כדי לנהל את הכיתה, אנחנו צריכים קודם כל ללמוד לנהל את הרגש של הלומדים. תודה רבה למיכל, תודה לכם המאזינים, ונתראה בפרק הבא של 'מחשבים מסלול פדגוגי'!"`,
    cards: [
